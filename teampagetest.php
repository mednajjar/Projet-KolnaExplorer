...
<body>
    ...
    <section id="teamPage" class="homePage">
        <div class="homePage__homeTitle">
            <h1>Team page</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, eveniet. Nulla dignissimos quia dolor, omnis labore assumenda, eius placeat fugiat voluptates corporis, doloremque quas quam. Impedit, ea repellat. Molestias, magni.</p>
        </div>
